...
const LAYER_BASELINE = [
  ...
  { file: "src/controllers/jobApplications.controller.ts", area: "src/db/jobs/", reason: REASONS.REPOSITORY },
  { file: "src/controllers/jobMetrics.controller.ts", area: "src/db/jobs/", reason: REASONS.REPOSITORY },
  { file: "src/controllers/jobs.controller.ts", area: "src/db/jobs/", reason: REASONS.REPOSITORY },
  { file: "src/controllers/jobsManagement.controller.ts", area: "src/db/jobs/", reason: REASONS.REPOSITORY },
