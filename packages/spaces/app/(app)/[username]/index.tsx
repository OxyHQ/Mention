    ...
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      >
        ...
        <View style={styles.statsRow}>
          ...
          <TouchableOpacity style={styles.statItem} onPress={() => router.push(`/(app)/@${cleanUsername}/followers` as any)}>
            <Text style={[styles.statNumber, { color: theme.colors.text }]}>{followerCount}</Text>
            <Text style={[styles.statLabel, { color: theme.colors.textSecondary }]}>Followers</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.statItem} onPress={() => router.push(`/(app)/@${cleanUsername}/following` as any)}>
