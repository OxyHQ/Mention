 ...
 * and the difference matters enough to name: `@crowdsource.you/core` builds the Case
  ...
  return {
    reportInput: {
      ...
      metadata: {
         ...
         * `buildModerationReportInput` is being lifted into `@crowdsource.you/core/outbox`
