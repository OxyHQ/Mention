...
const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  // Opening the reel takes the audible slot FIRST. The flying surface paints
  // whatever this element is showing, so tapping a row that does not hold the
  // slot flew a paused picture — measured at 324ms frozen against 11ms for the
  // row that did hold it. Claiming here means there is something to paint by the
    ...
    <View ref={containerRef} style={[styles.container, style]}>
      ...
      {!gif && (isPreviewMode ? (
        <>
          ...
          <Pressable style={styles.tapArea} onPress={handlePreviewPress} />
