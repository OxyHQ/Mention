...
export const PREMIUM_COLOR_NAMES: AppColorName[] = ['oxy', 'faircoin'];
...
export const APP_COLOR_PRESETS: Record<AppColorName, AppColorPreset> = {
  ...
  faircoin: {
    ...
    light: {
      ...
      '--chart-4': '92 60% 75%',
      '--chart-5': '92 60% 65%',
      '--content-area': '92 12% 95%',
      '--sidebar': '92 12% 95%',
      '--sidebar-foreground': '0 0% 12%',
      '--sidebar-primary': '92 90% 25%',
      '--sidebar-primary-foreground': '0 0% 100%',
      '--sidebar-accent': '92 10% 92%',
      '--sidebar-accent-foreground': '0 0% 12%',
      '--sidebar-border': '92 8% 85%',
      '--sidebar-ring': '92 90% 25%',
    },
    dark: {
      '--background': '69 54% 8%',
      '--foreground': '0 0% 93%',
      ...
      '--chart-4': '92 60% 55%',
      '--chart-5': '92 60% 45%',
      '--content-area': '69 40% 6%',
      '--sidebar': '69 40% 6%',
      '--sidebar-foreground': '0 0% 93%',
      '--sidebar-primary': '92 96% 65%',
      '--sidebar-primary-foreground': '0 0% 0%',
      '--sidebar-accent': '69 30% 13%',
      '--sidebar-accent-foreground': '0 0% 93%',
      '--sidebar-border': '69 20% 18%',
      '--sidebar-ring': '92 96% 65%',
    },
  },
};
