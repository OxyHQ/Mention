...
```
https://mention.earth/compose?text=...&url=...&hashtags=foo,bar
```
...
```html
<a
  href="https://mention.earth/compose?text=Check%20this%20out&url=https%3A%2F%2Fexample.com&via=mention"
  target="_blank"
...
```
https://mention.earth/compose?text=Check%20out%20this%20podcast&url=https%3A%2F%2Fpodcast.example.com%2Fep42&hashtags=podcasts,tech&via=podcasts
```
...
```
https://mention.earth/compose?text=What%27s%20your%20favorite%20editor%3F&pollOptions=Vim%7CEmacs%7CVSCode%7CHelix&pollDurationDays=3
```
...
```
https://mention.earth/compose?quotePostId=abc123&text=My%20take
```
...
```
https://mention.earth/compose?eventName=Meetup&eventDate=2026-06-15T18%3A00%3A00Z&eventLocation=Barcelona
```
