...
export const Home = ({ color = 'currentColor', size = 26, style, className }: { color?: string; size?: number; style?: ViewStyle; className?: string }) => {
  return (
    <IconSvg viewBox="0 0 26 26" width={size} height={size} style={{ ...style }} className={className}>
      <Path
...
export const HomeActive = ({ color = 'currentColor', size = 26, style, className }: { color?: string; size?: number; style?: ViewStyle; className?: string }) => {
  return (
    <IconSvg viewBox="0 0 26 26" width={size} height={size} style={{ ...style }} className={className}>
      <Path
