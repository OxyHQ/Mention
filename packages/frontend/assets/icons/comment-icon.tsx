...
export const CommentIcon = ({ color = '#005c67', size = 26, style }: { color?: string; size?: number; style?: ViewStyle }) => {
  return (
...
export const CommentIconActive = ({ color = '#005c67', size = 26, style }: { color?: string; size?: number; style?: ViewStyle }) => {
  return (
    <Svg viewBox="0 0 18 18" width={size} height={size} style={{ ...style }}>
