...
export const Chat = ({ color = '#005c67', size = 26, style }: { color?: string; size?: number; style?: ViewStyle }) => {
  return (
...
export const ChatActive = ({ color = '#005c67', size = 26, style }: { color?: string; size?: number; style?: ViewStyle }) => {
  return (
    <Svg viewBox="0 0 24 24" width={size} height={size} style={{ ...style, transform: [{ translateY: 2 }] }}>
