...
exports.scheduleDemoNotification = scheduleDemoNotification;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Notifications.scheduleNotificationAsync({
                            content: {
                                title: i18next_1.default.t("notification.welcome.title"),
                                body: i18next_1.default.t("notification.welcome.body"),
...
function createNotification(title_1, body_1) {
