...
exports.default = FollowingScreen;
...
function FollowingScreen() {
    ...
    var _d = (0, react_1.useState)([]), following = _d[0], setFollowing = _d[1];
    var _e = (0, react_1.useState)(null), profile = _e[0], setProfile = _e[1];
    var t = (0, react_i18next_1.useTranslation)().t;
    (0, react_1.useEffect)(function () {
        var loadFollowing = function () { return __awaiter(_this, void 0, void 0, function () {
            var userProfile, followingList, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, oxyServices.getUserFollowing(userProfile._id)];
                    case 2:
                        followingList = _a.sent();
                    ...
                    case 4:
                        error_1 = _a.sent();
                        console.error('Error loading following:', error_1);
                        return [3 /*break*/, 6];
                    case 5:
                        setLoading(false);
                        return [7 /*endfinally*/];
    ...
    if (loading) {
        ...
        <Header_1.Header options={{ title: t("Following"), showBackButton: true }}/>
        <react_native_1.ActivityIndicator style={{ marginTop: 20 }}/>
      </react_native_1.View>);
    }
    return (<react_native_1.View style={{ flex: 1 }}>
      <Header_1.Header options={{ title: "".concat(((_a = profile === null || profile === void 0 ? void 0 : profile.name) === null || _a === void 0 ? void 0 : _a.first) ? "".concat(profile.name.first, " ").concat(profile.name.last || '').trim() : username, " ").concat(t("Following")), showBackButton: true }}/>
      <react_native_1.FlatList data={following} renderItem={renderUser} keyExtractor={function (item) { return item._id || item.userID; }} ListEmptyComponent={<react_native_1.View style={{ padding: 16, alignItems: 'center' }}>
            <ThemedText_1.ThemedText>{t("No following yet")}</ThemedText_1.ThemedText>
          </react_native_1.View>}/>
    </react_native_1.View>);
}
