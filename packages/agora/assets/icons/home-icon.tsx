...
export const Home = ({ color = '#000', size = 26, style }: { color?: string; size?: number; style?: ViewStyle }) => {
  return (
...
export const HomeActive = ({ color = '#000', size = 26, style }: { color?: string; size?: number; style?: ViewStyle }) => {
  return (
    <Svg viewBox="0 0 26 26" width={size} height={size} style={{ ...style }}>
      <Path
