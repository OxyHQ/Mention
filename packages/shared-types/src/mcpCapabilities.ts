...
export const MENTION_TOOL_POLICIES: Readonly<Record<string, MentionToolPolicy>> = {
  ...
  "move-post-to-lane": write("PATCH", "/posts/{id}/lane", "administer", "social.posts.update", ["mention_account", "post", "lane"], { rollback: "supported" }),
  ...
  "create-lane": write("POST", "/lanes", "create", "social.lanes.manage", ["mention_account", "lane"], { rollback: "supported" }),
  "update-lane": write("PATCH", "/lanes/{id}", "administer", "social.lanes.manage", ["mention_account", "lane"], { rollback: "supported" }),
