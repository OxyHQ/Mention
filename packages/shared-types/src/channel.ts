...
export const CHANNEL_VISIBILITIES: readonly ChannelVisibility[] = ['public'];
...
export const CHANNEL_MEMBER_ROLES: readonly ChannelMemberRole[] = ['owner', 'publisher'];
...
export const CHANNEL_MEMBER_STATUSES: readonly ChannelMemberStatus[] = [
  'pending',
  'accepted',
  'declined',
  'removed',
