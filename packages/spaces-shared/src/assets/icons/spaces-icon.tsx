...
export const Spaces = ({ color = DEFAULT_COLOR, size = 26, style }: { color?: string; size?: number; style?: ViewStyle }) => (
...
export const SpacesActive = ({ color = DEFAULT_COLOR, size = 26, style }: { color?: string; size?: number; style?: ViewStyle }) => (
  <Svg viewBox="0 0 24 24" width={size} height={size} style={{ ...style }}>
