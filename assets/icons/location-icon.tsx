...
export const LocationIcon = ({ color = colors.primaryColor, size = 26, style }: { color?: string; size?: number; style?: CSSProperties }) => {
  return (
    <svg fill="currentColor" width={size} viewBox="0 0 24 24" height={size} aria-hidden="true" style={{ ...style, color }}>
