...
export const HomeActive = ({ color = colors.primaryColor, size = 26, style }: { color?: string; size?: number; style?: CSSProperties }) => {
  return (
    <svg className="svgIcon" viewBox="0 0 26 26" aria-hidden="true" style={{ ...style, width: size, height: size }}>
      <g>
        <path
...
export const Home = ({ color = colors.primaryColor, size = 26, style }: { color?: string; size?: number; style?: CSSProperties }) => {
  return (
    <svg className="svgIcon" viewBox="0 0 26 26" style={{ ...style, width: size, height: size }} >
      <path
