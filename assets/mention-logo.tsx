...
export const MentionLogo = ({ color = colors.primaryColor, size = 48, style }: { color?: string; size?: number; style?: CSSProperties }) => {
  return (
    <svg viewBox="0 0 196 196" aria-label="Mention" role="img" style={{ ...style, width: size, height: size }}>
      <path
