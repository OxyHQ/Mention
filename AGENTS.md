...
- **Auth**: Oxy integration via `@oxyhq/core ^3.5.0` + `@oxyhq/services ^10.3.0`
...
- `@oxyhq/core ^3.5.0`, `@oxyhq/services ^10.3.0` — Oxy platform SDK
- `@oxyhq/bloom ^0.9.0` — Shared UI component library (`AvatarGroup` at `@oxyhq/bloom/avatar-group`, `UserHoverCard` at `@oxyhq/bloom/user-hover-card`)
